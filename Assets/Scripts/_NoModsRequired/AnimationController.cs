...
public class AnimationController : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        ourSpot.intensity = Mathf.Lerp(defeatedInten, ourSpot.intensity, character.health);
        anim.speed = mojoToSpeedCurve.Evaluate(1 - character.health);

        if (hpImage != null)
        {
            hpImage.fillAmount = Mathf.Lerp(hpImage.fillAmount, character.health, Time.deltaTime);
        }
    }
